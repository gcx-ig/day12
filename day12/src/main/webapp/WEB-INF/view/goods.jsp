...
<body class="gray-bg">
	...
	<!-- 新增类型对话框 -->
	<div class="modal fade" id="modal_user_addd" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addd" method="post" action="adddgoods.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>分类名称：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_addd_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    var validator = $("#form_addd").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#submit_form_addd_btn").click(function(){
	    	$("#form_addd").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addd").click(function(){
	    		$('#modal_user_addd').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_addd').modal('show');
	        });
